    ...
    <div class="chat-container">
      <header class="chat-header">
        ...
        <div class="header-user">
          ...
          <span style="margin-left: 5px">用户昵称</span>
      ...
      <div class="order-detail">
        <div class="details-box" @click="toMain()">
          <el-image  style=" width: 100%;height: 100%;border-radius: 5px;" src="@/assets/logo.jpg" fit="cover"></el-image>
        ...
        <div class="info" >
          ...
          <div class="product-info" @click="toMain()">
            <div class="interaction-price">￥999</div>
            ...
            <!-- <div class="postType" v-if="productInfo.postType ===0 ">邮寄</div>
            <div class="postType" v-if="productInfo.postType ===1 ">自提</div> -->
          </div>
          <div class="buy">
            <el-button type="danger" round @click="purchase">购买</el-button>
            <!-- <el-button type="danger" round @click="purchase" v-if="productInfo.status === 9 &&productInfo.userId!==userInfo.id">购买</el-button> -->
          </div>
        </div>
      </div>
