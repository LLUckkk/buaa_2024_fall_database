<template>
  <div class="container">
    <div class="push-container">
      ...
      <div class="header-title" style="margin-top: 10px;margin-bottom: 15px;font-size: 18px;padding-left: 20px"> 物流信息</div>
      <div style="margin-left: 20px">
        <el-descriptions class="margin-top" :column="2" border>
          ...
          <el-descriptions-item >
            ...
            <span v-if="productOrder.postMode==='物流发货'"> {{ productOrder.postUsername }} {{ productOrder.postPhone }} {{ productOrder.postAddress }}</span>
            <span v-if="productOrder.postMode==='用户自提'"> {{ productOrder.shipUsername }} {{ productOrder.shipPhone }} {{ productOrder.shipAddress }}</span>
          </el-descriptions-item>
        </el-descriptions>
      </div>
      <div style="margin-left: 20px">
      ...
      <div class="header-title" style="margin-top: 10px;margin-bottom: 15px;font-size: 18px;padding-left: 20px"> 订单信息</div>
      <div style="margin-left: 20px">
      ...
      <div class="header-title" style="margin-top: 10px;margin-bottom: 15px;font-size: 18px;padding-left: 20px"> 评价信息</div>
      <div style="margin-left: 20px">
        <div class="info">
          <div>
            <div class="user-info">
