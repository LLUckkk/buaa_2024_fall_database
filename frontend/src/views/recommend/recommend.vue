  ...
  <div class="container" id='container'>
    ...
    <div class="top">
      <header class="mask-paper">
        <a style="display: flex;"> <!--logo图片未设置-->
          <img class="logo" style="width:72px;height: 72px;margin-top: 20px;" src=""/>
          <span style="line-height: 100px; font-weight: bolder;font-size: 30px;margin-left: 20px;letter-spacing: 5px">UniTradeZone</span>
        </a>
        <div class="tool-box"></div> <!--下面有vshow没设置-->
        ...
        <ul class="channel-list">
          ...
          <li :class="$route.path === '/followtrend' ? 'active-channel':''" v-if="loginStatus">
            <a class="link-wrapper" @click="toTrend()">
              ...
              <span class="channel">集市</span>
            </a>
          </li>
          
          <li :class="$route.path === '/message' ? 'active-channel':''" v-if="loginStatus">
          ...
          <li :class="$route.path === '/release' ? 'active-channel':''" v-if="loginStatus">
