...
public class TokenService : ITokenService
{
    ...
    public string GenerateToken(string userid, string role)
    {
        var claims = new[]
        {
            ...
            new Claim(ClaimTypes.Expiration, DateTime.UtcNow.AddHours(12).ToString())
        };
        ...
        // _tokens.TryAdd(tokenStr, token.ValidTo);
        return "deprecated, use cookie";
    }
